...
export const high_scores = localPersistentStore<Scores>('high-scores', default_scores);

export function updateHighScore(configuration: string, new_high_score: number) {
