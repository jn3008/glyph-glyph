...
export const cyrillic = {
	...
	pronunciations: {
		...
		ukrainian: {
			'а': ['f', 'a', 'ther'], 'б': ['', 'b', 'ed'], 'в': ['', 'v', 'ine'],
			'г': ['', 'h', 'ello (voiced)'], 'ґ': ['', 'g', 'o'], 'д': ['', 'd', 'og'],
			'е': ['b', 'e', 'd'], 'є': ['', 'ye', 's'], 'ж': ['mea', 's', 'ure'],
			'з': ['', 'z', 'oo'], 'и': ['s', 'i', 't'], 'і': ['mach', 'i', 'ne'],
			'ї': ['', 'yee', 's'], 'й': ['', 'y', 'es'], 'к': ['', 'k', 'ite'],
			'л': ['', 'l', 'amp'], 'м': ['', 'm', 'an'], 'н': ['', 'n', 'o'],
			'о': ['m', 'o', 're'], 'п': ['', 'p', 'ot'], 'р': ['pe', 'rr', 'o (rolled)'],
			'с': ['', 's', 'un'], 'т': ['', 't', 'op'], 'у': ['b', 'oo', 't'],
			'ф': ['', 'f', 'un'], 'х': ['lo', 'ch', ' (Scottish)'], 'ц': ['si', 'ts', ''],
			'ч': ['', 'ch', 'ess'], 'ш': ['', 'sh', 'oe'], 'щ': ['', 'shch', ' (sh + ch)'],
			'ь': ['silent, softens the preceding consonant', '', ''],
			'ю': ['', 'yu', 'le'], 'я': ['', 'ya', 'rd']
		}
	},
...
export const hangul = {
	...
	// Weighted distrubution for generating realistic hangul syllable
	// https://www.kref.altervista.org/kreffrequency.html
	weights: {
		initial_consonants: [
			0.12124, 0.0109, 0.0378, 0.0597, 0.01, 0.0528, 0.0543, 0.0684, 0.01, 0.10884, 0.01, 
			0.14054, 0.12084, 0.01, 0.0405, 0.01, 0.0159, 0.0209, 0.09734
		],
	
		vowels:	[
			0.2353, 0.0520, 0.01, 0.01, 0.1052, 0.0173, 0.0487, 0.01, 0.1021, 0.0154, 
			0.01, 0.0163, 0.0156, 0.1007, 0.01, 0.01, 0.01, 0.01, 0.0485, 0.01, 0.1525
		],

		final_consonants: [
			0.36, 0.07615, 0.01, 0.01, 0.11789, 0.01, 0.01, 0.01, 0.06959, 0.01, 0.01, 
			0.01, 0.01, 0.01, 0.01, 0.01, 0.03859, 0.02309, 0.005, 0.01, 0.01, 
			0.10909, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01
		]
	},
